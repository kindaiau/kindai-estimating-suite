    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-white/5 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">Email: <a href="mailto:hello@kindaiestimator.com?subject=Legal" className="text-orange-400 hover:underline">hello@kindaiestimator.com</a></p>
              <p className="text-gray-400 text-sm mt-1">Support: <a href="mailto:hello@kindaiestimator.com" className="text-orange-400 hover:underline">hello@kindaiestimator.com</a></p>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-wrap gap-4 text-sm text-white/40">
          ...
          <a href="mailto:hello@kindaiestimator.com?subject=Legal" className="hover:text-orange-400 transition-colors">Contact</a>
        </div>
      </div>
    </div>
  );
