...
const TRADES = [
  ...
  { id: "gas-install",     name: "Gas Installation", emoji: "🔥", gradient: "from-orange-400 to-red-500" },
  { id: "gas-maintenance", name: "Gas Maintenance",  emoji: "🛠️", gradient: "from-amber-400 to-orange-500" },
];
