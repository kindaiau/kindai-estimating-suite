...
export default function DataDeletion() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Something went wrong. Please email us directly at hello@kindaiestimator.com");
    }
  };
        ...
        {!submitted ? (
          <>
            ...
            <p className="text-xs text-white/30 mt-6 text-center">
              ...
              <a href="mailto:hello@kindaiestimator.com?subject=Privacy%20%26%20Data" className="text-orange-400 hover:underline">
                hello@kindaiestimator.com
              </a>
            </p>
          </>
        ) : (
