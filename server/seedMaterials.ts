...
const SEED_MATERIALS: SeedMaterial[] = [
  ...
  { trade: "electrical", category: "EV Charging", name: "Tesla Gen 3 Wall Connector 7.3m", description: "Type 2 residential wall connector, up to 7kW single phase / 11kW three phase", unit: "ea", unitPrice: "745.00", supplier: "Tesla/Bunnings", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Evnex E2 Flex 7.4kW EV Charger", description: "Entry smart home EV charger, 5m Type 2 cable, grid-ready with solar upgrade option", unit: "ea", unitPrice: "799.00", supplier: "Evnex", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Evnex E2 Core 7.4kW EV Charger", description: "Smart solar-ready home EV charger with Wi-Fi, overload protection and Type 2 cable", unit: "ea", unitPrice: "1099.00", supplier: "Evnex", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Ocular IQ Home Solar 7kW EV Charger", description: "Solar-ready residential EV charger with 5m Type 2 cable, app control and OCPP", unit: "ea", unitPrice: "1195.00", supplier: "EVSE/Ocular", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Ocular IQ Wallbox V2 7kW", description: "OCPP smart wallbox with 5m Type 2 cable, RFID and billing-capable functions", unit: "ea", unitPrice: "1769.00", supplier: "EVSE/Ocular", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Projecta 22kW EV Wall Charger", description: "Single/three phase wall charger, 7-22kW configurable, IP65 outdoor rated", unit: "ea", unitPrice: "1533.00", supplier: "Repco/Projecta", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Residential EV Charger - Buyer Allowance", description: "Mid-market wholesale allowance for Ocular/Zappi/Wallbox/Evnex-class residential charger where brand is not specified", unit: "ea", unitPrice: "1200.00", supplier: "Market allowance", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging", name: "Premium Solar EV Charger - Buyer Allowance", description: "Premium solar/OCPP charger allowance for Zappi/Ocular/Wallbox class units before installation", unit: "ea", unitPrice: "1650.00", supplier: "Market allowance", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Protection", name: "40A Type A RCBO/RCD Protection - Single Phase EV", description: "Dedicated 40A Type A circuit protection for 32A single-phase EV charger circuit", unit: "ea", unitPrice: "95.00", supplier: "Clipsal/Schneider/Hager", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Protection", name: "40A Type A RCD/RCBO Protection - Three Phase EV", description: "Dedicated Type A RCD/RCBO protection for three-phase EV charger circuit", unit: "ea", unitPrice: "180.00", supplier: "Clipsal/Schneider/Hager", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Protection", name: "Type B EV RCD Allowance", description: "Required where charger does not include 6mA DC fault detection; higher-cost protection allowance", unit: "ea", unitPrice: "420.00", supplier: "Schneider/ABB/Hager", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Protection", name: "Weatherproof EV Isolator 40-63A", description: "IP66 local isolator for external/distant charger locations where required or advisable", unit: "ea", unitPrice: "65.00", supplier: "Clipsal/Schneider/Chint", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Cabling", name: "6mm TPS Cable - Dedicated EV Circuit", description: "Minimum cable allowance for standard 32A domestic EV charger circuit; confirm voltage drop and route", unit: "m", unitPrice: "7.80", supplier: "Prysmian/Olex", wasteFactor: "10" },
  { trade: "electrical", category: "EV Charging Cabling", name: "6mm 4-Core + Earth Cable - Three Phase EV", description: "Three-phase cable allowance for 11-22kW EV charger circuit; confirm installation method and derating", unit: "m", unitPrice: "18.50", supplier: "Prysmian/Olex", wasteFactor: "10" },
  { trade: "electrical", category: "EV Charging Cabling", name: "EV Charger Consumables Pack", description: "Glands, saddles, fixings, labels, ferrules, lugs and small consumables for one charger install", unit: "pack", unitPrice: "85.00", supplier: "Electrical wholesaler", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Labour", name: "EV Charger Install Labour - Standard", description: "Licensed electrician labour allowance for charger mount, dedicated circuit, protection, testing and commissioning", unit: "lot", unitPrice: "900.00", supplier: "Labour allowance", wasteFactor: "0" },
  { trade: "electrical", category: "EV Charging Labour", name: "Switchboard Upgrade Allowance for EV Charger", description: "Provisional allowance where board space, main switch, RCD compliance or load management work is required", unit: "lot", unitPrice: "650.00", supplier: "Labour/material allowance", wasteFactor: "0" },
