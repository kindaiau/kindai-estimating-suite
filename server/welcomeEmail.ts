          ...
          <tr>
            <td style="background:#111111;padding:40px 48px;">
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #1e1e1e;">
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="padding-left:14px;color:#cccccc;font-size:15px;">Head to <a href="https://kindaiestimator.com" style="color:#ff6b35;text-decoration:none;font-weight:600;">kindaiestimator.com</a> and sign in</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                <tr>
                  <td align="center">
                    <a href="https://kindaiestimator.com" style="display:inline-block;background:linear-gradient(135deg,#ff6b35,#ff8c42);color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;padding:16px 48px;border-radius:50px;letter-spacing:0.5px;">
              ...
              <p style="margin:0;color:#666666;font-size:14px;line-height:1.6;">
                P.S. Got a tradie mate who'd love this? Forward them: <a href="https://kindaiestimator.com/beta" style="color:#ff6b35;text-decoration:none;">kindaiestimator.com/beta</a> — we'll open more spots if demand is there.
              </p>
          ...
          <tr>
            <td style="background:#0d0d0d;border-radius:0 0 16px 16px;padding:24px 48px;text-align:center;border-top:1px solid #1a1a1a;">
              <p style="margin:0 0 8px;color:#444444;font-size:13px;">
                <a href="https://kindaiestimator.com" style="color:#ff6b35;text-decoration:none;font-weight:600;">kindaiestimator.com</a>
                &nbsp;·&nbsp;
